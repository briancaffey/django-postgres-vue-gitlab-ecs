...
It would be good to define RecordSets and RecordSetGroups in CloudFormation.

We should only have to specify the hosted zone ID


## Elasticache

https://github.com/aws-samples/startup-kit-templates/blob/master/templates/elasticache.cfn.yml
