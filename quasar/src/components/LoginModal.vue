  ...
  <div>
    <q-dialog @hide="hideLoginMenu" v-model="visible">
      <q-card style=" max-width: 95%; min-width: 320px;">
        ...
        <q-form @submit="login">
          <q-card-section>
            <q-input id="email" v-model="email" type="text" label="Email" autofocus />
            <q-input id="password" type="password" v-model="password" label="Password" />
          </q-card-section>

          <q-card-actions align="right" class="text-primary">
            <q-btn tabindex="-1" flat label="Cancel" v-close-popup />
            <q-btn id="login-btn" flat label="Login" type="submit" v-close-popup />
          </q-card-actions>
        </q-form>
      </q-card>
    </q-dialog>
